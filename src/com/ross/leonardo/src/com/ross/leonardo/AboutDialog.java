...
public class AboutDialog extends JDialog {
    ...
    public AboutDialog(JFrame parent) {
        ...
        Image appImage = AppInfo.getAppImage();
        if (appImage != null) {
     ...
     // ----- Icon -----
        ImageIcon originalIcon = AppInfo.getImageIcon();
     ...
     // ----- Buttons -----
        ...
        donateButton.addActionListener(e -> openDonatePage());
    ...
    private void openDonatePage() {
        try {
            Desktop.getDesktop().browse(new URI(AppInfo.DONATE_URL));
        } catch (Exception ex) {
